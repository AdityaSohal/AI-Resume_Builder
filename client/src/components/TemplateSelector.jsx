...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        ...
        },
        {
            id: 'minimal-image',
            name: 'Minimal Image',
            preview: 'Minimal design with simple image and clean typography',
        },
        {
            id: 'minimal',
            name: 'Minimal',
            preview: 'Ultra clear design that puts your content front and center',
        },
    ]
    ...
    return (
        <div className='relative'>
            <button
                ...
                className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-r from-blue-50 to-blue-100 ring-1 ring-blue-300 hover:ring-2 transition-all px-3 py-2 rounded-lg'
            >
                <Layout size={14} />
                    ...
                    {templates.map((template) => (
                        ...
                        >
                            ...
                            <div className='space-y-1'>
                                ...
                                <div className='mt-2 p-2 bg-blue-50 rounded text-sm text-gray-600 italic'>
                                    {template.preview}
                                </div>
                            </div>
                        </div>
