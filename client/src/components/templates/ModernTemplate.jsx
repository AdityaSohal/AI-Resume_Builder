        ...
        <div className="max-w-4xl mx-auto bg-white text-gray-800">
            <header className="p-8 text-white" style={{ backgroundColor: accentColor }}>
                ...
                {data.personal_info?.profession && (
                    <p className="text-lg mb-4">{data.personal_info.profession}</p>
                )}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    ...
                    {data.personal_info?.personal_website && (
                        <a target="_blank" rel="noreferrer" href={data.personal_info.personal_website} className="flex items-center gap-2">
                            <Globe className="size-4" />
                            <span className="break-all text-xs">
                                {data.personal_info.personal_website.split("https://")[1] || data.personal_info.personal_website}
                            </span>
                        </a>
                    )}
                </div>
