...
const Action = () => {
    return (
        <div className='border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-10 sm:px-16 mt-30 pb-30'>
...
Stand Out and Get Hired.</p>
                <Link to="/app?state=resister" className="flex items-center gap-2 rounded-full py-3 px-8 bg-green-600 hover:bg-green-800 transition text-white">
