...
import { login } from '../app/features/authSlics'
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 py-8 bg-white shadow-lg">
                ...
                <p className="text-gray-500 text-sm mt-3 mb-0">
                    ...
                    <a href="#" onClick={(e) => { e.preventDefault(); setState(prev => prev === "login" ? "register" : "login"); }} className="text-green-600 hover:underline">
                        click here
                    </a>
                </p>
            </form>
