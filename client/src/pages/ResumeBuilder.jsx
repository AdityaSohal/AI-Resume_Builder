      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            {/* FIX: action buttons moved ABOVE the preview, not absolutely positioned inside it.
                Previously they were inside a relative div with no height, causing them to render
                on top of the resume preview content. */}
            <div className="flex items-center justify-end gap-2 mb-3">
              ...
              <button
                ...
                className="flex items-center gap-1 p-2 px-3 text-sm bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg ring-green-300 hover:ring transition-colors"
              >
